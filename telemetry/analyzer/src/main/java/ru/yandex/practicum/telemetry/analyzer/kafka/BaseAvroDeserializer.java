...
public class BaseAvroDeserializer<T extends SpecificRecordBase> implements Deserializer<T> {
    ...
    BaseAvroDeserializer(DecoderFactory decoderFactory, Schema schema) {
    ...
    @Override public T deserialize(String topic, byte[] data) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Не удалось десериализовать Avro-сообщение из топика " + topic, e);
        }
    }
}
