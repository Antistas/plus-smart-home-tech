...
public class Scenario {
    ...
    public void replaceConditions(Map<Sensor, Condition> value) {
        conditions.clear();
        conditions.putAll(value);
    }

    public void replaceActions(Map<Sensor, Action> value) {
        actions.clear();
        actions.putAll(value);
    }

    public void removeSensor(Sensor sensor) {
        conditions.remove(sensor);
        actions.remove(sensor);
    }
}
